...
```json
{
  ...
  "data": {
    ...
    "consecutive_threshold": 3,
    "enabled": true,
    "scheduler_arn": "arn:aws:scheduler:ap-northeast-1:123456789012:schedule/default/SiteMonitor-site-a1b2c3d4",
...
```json
{
  ...
  "data": [
    {
      "logGroupName": "/aws/lambda/DataTransferSystem2-ExBoard-Function1",
      "storedBytes": 1048576
    },
    {
...
例: `SiteMonitor-site-a1b2c3d4-e5f6-7890-abcd-ef1234567890`
...
完全なOpenAPI 3.0.3仕様は `/openapi/openapi.yaml` を参照。Swagger UIは `https://openapi.example-cloud.com/site-monitor/` で閲覧可能。
