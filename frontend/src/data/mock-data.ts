    ...
    targets: [
      {
        ...
        json_search_word: '99999999@ml.example-cloud.com',
        search_period_minutes: 60,
      },
    ],
...
export const mockStatusChanges: StatusChange[] = [
  ...
  { site_id: 'site-003', changed_at: '2026-04-06T08:50:00+09:00', previous_status: 'updated', new_status: 'error', trigger_url: 'DataTransferSystem2-ExBoard-Function1' },
...
export const mockNotifications: Notification[] = [
  { site_id: 'site-001', notification_id: 'notif-001', type: 'email', destination: 'testuser@example.com', mention: '', message_template: '', enabled: true },
  { site_id: 'site-001', notification_id: 'notif-002', type: 'slack', destination: '/site-monitor/slack-webhook-url', mention: '@channel', message_template: '', enabled: true },
  { site_id: 'site-002', notification_id: 'notif-003', type: 'email', destination: 'tanaka@example.com', mention: '', message_template: '', enabled: true },
]
